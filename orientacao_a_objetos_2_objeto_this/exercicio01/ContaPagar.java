...
public class ContaPagar {
    ...
    void pagar(){
        ...
        if (SituacaoConta.PAGA.equals(this.getSituacaoConta())){
            situacaoConta = SituacaoConta.CANCELADA ; System.out.println("A conta já foi cancelada e não pode ser paga" + this.getDescricao() + ".");
    }
        else{}
    ...
    public void cancelar() {
        System.out.println("não se pode cancelar uma conta que já foi cancelada ou paga.");
    }
}
