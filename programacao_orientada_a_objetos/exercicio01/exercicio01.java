 ...
 */
    ...
    public static void main(String[] args) {
       ...
       System.out.println("Nescessário repor estoque do produto " + estoque.nome + " ? " + exibirQuantidadeNoEstoque(estoque));

    }


    private static Boolean exibirQuantidadeNoEstoque(Estoque estoque) {
