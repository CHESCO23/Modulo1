 ...
 */
    public static void main(String[] args) {
        ...
        System.out.println("Quantos produtos deseja caastrar? ");
        int quantidadeProdutos = scanner.nextInt();
        scanner.nextLine();

        // agora iremos injetar a classe estoque no codigo.
        Estoque estoque = new Estoque();
        //
        estoque.produtos = new produto[quantidadeProdutos];

        //o for sempre vai junto com um vetor.
        for (int i = 0; i < estoque.produtos.length; i++){
            ...
            System.out.println("\nproduto " + i);
            System.out.println("--------------------------");
            System.out.println("Informe a descrisão do produto: ");
